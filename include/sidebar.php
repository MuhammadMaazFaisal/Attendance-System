        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link collapsed sb-sidenav-menu-heading-margin" href="#" data-toggle="collapse" data-target="#collapseLayouts"
...
if ($_SESSION['user_access'] == "Employee") {?>
                    <a class="nav-link sb-sidenav-menu-heading-margin" href="dashboard.php">
                        <div class="sb-nav-link-icon"><i class="feather-home"></i></div>
                        Dashboard
                    </a>
