                                            ...
                                            <div class="col-md-8 add_top_30">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <input class="form-control" id="time_out" name="time_out" step="900" type="time" ng-model="endTime" pattern="[0-9]*" value="--:--" required />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                    <button class="btn btn-outline-secondary" type="button" id="button-addon1" onclick="PrintSetter($('#user_id').val())">Print</button>                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /row-->
