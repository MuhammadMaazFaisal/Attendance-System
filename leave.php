        ...
        <div class="container-fluid">
            <div class="row mr-5">
                ...
                <div class="col-12 col-md-3 my-3 border border-secondary rounded ml-auto">
                    ...
                    <div class="row mx-2">
                        <span class="font-weight-bold">Pending Leaves: </span><span id="pending_leaves"
                            class="mx-2"></span>
                    </div>
                    <div class="row mx-2">
                        <span class="font-weight-bold">Accepted Leaves: </span><span id="approved_leaves"
                            class="mx-2"></span>
                    </div>
                    <div class="row mx-2">
                        <span class="font-weight-bold">Rejected Leaves: </span><span id="rejected_leaves"
                            class="mx-2"></span>
                    </div>
