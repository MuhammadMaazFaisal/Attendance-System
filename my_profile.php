                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-group ml-5">
                                            ...
                                            <img id="profile_pic" src="" class="img-thumbnail"
                                                style="margin-left:70px; width: 200px; height:200px">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-8 add_top_30">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Gender</label>
                                                <input id="gender" type="text" class="form-control" placeholder="Male"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="qualification" type="text" class="form-control"
                                            placeholder="Qualification" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="current_address" type="text" class="form-control"
                                            placeholder="Current Address" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="martial_status" type="text" class="form-control"
                                            placeholder="Martial Status" readonly>
                                    </div>
                                </div>
                            </div>
                            <!-- /row-->
